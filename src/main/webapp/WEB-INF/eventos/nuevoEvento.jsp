...
<title>Eventos - Nuevo Evento</title>
</head>
<body class="fondo">
		...
		<div class="signup-form-container">
			...
			<div class="form-header">
				<h3 class="registration">
					<i class="fa fa-rebel"></i>Agregar nuevo evento
				</h3>
			</div>
				...
				<div class="form-group">
					<div>
						<div class="form-body">
							<div class="form-group">
								<div>
									<form:form modelAttribute="evento" method="post"
										action="insertar" class="credentials">
										Nombre del evento:
										...
										<div class="input-group" style="margin-top: 10px;">
											...
											<form:input path="tipoEvento" cssClass="form-control"
										...
										<div class="input-group" style="margin-top: 10px;">
											...
											<form:input path="asientosDisponibles" type="number"
												cssClass="form-control" placeholder="Asientos Disponibles" />
										</div>
										...
										<div class="input-group" style="margin-top: 10px;">
											...
											<form:input path="grupoId" type="number"
												cssClass="form-control" placeholder="GrupoId" />
										</div>
										<form:errors path="grupoId" cssClass="text-danger" />

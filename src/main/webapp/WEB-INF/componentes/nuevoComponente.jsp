				...
				<div class="col-6">
					<div class="form-body">
						<div class="form-group">
							<div>
								<form:form modelAttribute="componente" id="login-usuarios"
									autocomplete="off" class="credentials" method="post"
									action="${pageContext.request.contextPath}/componentes/insertar">
									Nombre del componente musical:
									...
									<div class="input-group" style="margin-top: 10px;">
										<form:input path="instrumento" type="text"
											class="form-control fontAwesome" placeholder="Instrumento" />
									</div>
									<form:errors path="instrumento" cssClass="text-danger" />
									<p></p>
									ID del grupo:
									<div class="input-group" style="margin-top: 10px;">
										<input name="grupo.grupoId" type="text" readonly="readonly"
											class="form-control fontAwesome"
											value="${componente.grupo.grupoId}">
									</div>
									<p></p>
									...
									<span class="input-group-btn">
										<button type="reset" class="btn btn-info"
											onclick="window.location.href='${pageContext.request.contextPath}/grupos/detalle?grupoId=${componente.grupo.grupoId}'">Cancelar</button>
									</span>

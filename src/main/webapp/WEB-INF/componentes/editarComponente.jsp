		...
		<div class="signup-form-container">
			...
			<div class="form-header">
				<h3 class="registration">
					<i class="fa fa-microphone"></i>Editar componente
				</h3>
			</div>
						...
						<div class="form-group">
							<div>
								<form:form role="form" id="login-usuarios" autocomplete="off"
									...
									action="${pageContext.request.contextPath}/componentes/actualizar"
									modelAttribute="componente">
									ID del componente:
									<div class="input-group" style="margin-top: 10px;">
										<form:input path="componenteId" type="text" readonly="true"
											cssClass="form-control fontAwesome" />
									</div>
									<form:hidden path="componenteId" />
									<p></p>
									...
									<a class="btn btn-info"
										href="${pageContext.request.contextPath}/grupos/detalle?grupoId=${componente.grupo.grupoId}">
										Cancelar </a>
